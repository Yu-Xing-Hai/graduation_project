...
BASE_MODEL_PATH = "/apps/users/icps_intelligence/data/dhc/model/qwen-7b/qwen-7b-local"
# ========================= 二、LoRA相关 =======================
## LoRA权重路径（训练后保存的最终权重）
LORA_WEIGHTS_PATH = "/apps/users/icps_intelligence/data/dhc/model/qwen-7b/lora_checkpoints/qwen-lora-as-final"
